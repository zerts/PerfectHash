...
{
	return rnd.next(0ull, (unsigned long long)(INT_MAX)-2ull);
}
...
void testingInit(unsigned int n)
{
	...
	//2 - ��� ���������� ������. ���������.
	//3 - k0, k0, k0, k0,..., k0
	//4 - k0, k1, k0, k1, �, k0, k1. ��� + random_shuffle + ��� ������������ �����
	//5 - k0, k0, k1, k1, k2, k2,...,kn/2, kn/2. �� ��.
	//6 - k0, k1, k2, �, kn-2, k0. �� ��.
	//7 - k0, k1, k2, �, kn-3, k0, k1. �� ��
	//8 - (k0, k1, k2, �, k sqrt(n)) * sqrt(n). �� �� + random_shuffle ������.
	//9 - ������� �������� ������.
